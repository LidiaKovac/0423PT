...
//prendere il valore dell'input e mostrare "in tempo reale"
//gli utenti che nel nome hanno il valore dell'input

//! ingredienti: 

//funzione con ciclo su utenti, 
//ritorna solo i nomi se coincide con la query

//! onkeyup
const ul = document.querySelector("ul")

const searchUser = function (keyboardEvent) {
    ul.innerHTML = ""
    //! for
    //! if
    for (let i = 0; i < utenti.length; i++) {
        if (utenti[i].firstName.toLowerCase().includes(keyboardEvent.target.value.toLowerCase())) {
            ul.innerHTML += `<li>${utenti[i].firstName}</li>`
        }
    }
...
//! Element.addEventListener("tipo", fn)
